...
const Login = () => {
  ...
  const { backendUrl, setIsLoggedin, getUserData, setAxiosToken } = useContext(AppContext)
  ...
  const onSubmitHandler = async (e) => {
    try {
      ...
      axios.defaults.withCredentials = true // to send cookies also with the request
    ...
    <div className='flex items-center justify-center min-h-screen px-6 sm:px-0 bg-linear-to-br from-blue-200 to-purple-400'>
      ...
      <div className='bg-slate-900 p-10 rounded-lg shadow-lg w-full sm:w-96 text-indigo-300 text-sm '>
        ...
        <form onSubmit={onSubmitHandler}>
          ...
          <p className='mb-4'>
            <span onClick={() => navigate('/reset-password')} className=' text-indigo-500 cursor-pointer'>Forgot password?</span>
          </p>
